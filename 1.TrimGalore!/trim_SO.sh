...
command
mpirun -np 20 /home/Workshop-Genomics/softs/TrimGalore-0.6.5/trim_galore --quality 30 --phred33 --stringency 2 --length 30 --max_n 2 --trim-n --output_dir ./ --paired --retain_unpaired -j 20 SOT_R1.fastq.gz SOT_R2.fastq.gz 
